...
static const unsigned int MAX_BLOCK_SIGOPS = MAX_BLOCK_SIZE/5;
static const unsigned int MAX_ORPHAN_TRANSACTIONS = MAX_BLOCK_SIZE/100;
static const int64 MIN_TX_FEE = CENT;
static const int64 MIN_RELAY_TX_FEE = CENT;
static const int64 MAX_MONEY = 2000000000 * COIN;
static const int64 MAX_MINT_PROOF_OF_WORK = 808 * COIN;
...
static const int STAKE_MIN_AGE = 60 * 60 * 24 * 8.08; // minimum age for coin age 8.08 days
static const int STAKE_MAX_AGE = 60 * 60 * 24 * 808; // stake age of full weight 808 days
...
public:
    ...
    {
        // 808: the coin stake transaction is marked with the first output empty
    ...
    */
    ...
    bool GetCoinAge(CTxDB& txdb, uint64& nCoinAge) const;  // 808: get transaction coin age
...
public:
    ...
    // 808: block signature - signed by coin base txout[0]'s owner
    ...
    // 808: two types of block: proof-of-work or proof-of-stake
    ...
    // 808: get max transaction timestamp
    ...
    bool AcceptBlock();
    bool GetCoinAge(uint64& nCoinAge) const; // 808: calculate total coin age spent in block
    bool SignBlock(const CKeyStore& keystore);
    bool CheckBlockSignature() const;
    unsigned int GetStakeEntropyBit() const; // 808: entropy bit for stake modifier if chosen by modifier
...
public:
    ...
    unsigned int nFile;
    unsigned int nBlockPos;
    CBigNum bnChainTrust; // 808: trust score of block chain
    int nHeight;
    int64 nMint;
    int64 nMoneySupply;

    unsigned int nFlags;  // 808: block index flags
    enum  
    {
...
public:
    ...
    {
        CKey key;
        if (!key.SetPubKey(ParseHex("049415ca6444f4485e3aa55cd2505cf4af92de59aa5cdc6c5695a054bf3db1f08498226b167460d8b34b31e07b94e5c7d71544f8071be45ad33366240b1c8df55c")))
